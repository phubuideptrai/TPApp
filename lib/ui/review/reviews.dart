...
class Reviews extends StatefulWidget {
  ...
  Reviews({Key? key, required this.productID, required this.reviews})
      : super(key: key);
                    ...
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: NumberFormat("0.#")
                                .format(ratings[0] / widget.reviews.length)
                                .toString(),
                            style:
                                TextStyle(fontSize: 48.0, color: kPrimaryColor),
                          ),
                          TextSpan(
                            text: "/5",
                            style: TextStyle(
                    ...
                    itemBuilder: (context, index) {
                      return ReviewCard(
                        ...
                        user: userServices.getUserForReview(
                            users, widget.reviews[index].userID),
                      );
                    },
