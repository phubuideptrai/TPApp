...
class _MyOrderScreen extends State<MyOrderScreen>
  ...
  getOrders() async {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status1)
        .then((snapshots) {
      setState(() {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status2)
        .then((snapshots) {
      setState(() {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status3)
        .then((snapshots) {
      setState(() {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status4)
        .then((snapshots) {
      setState(() {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status5)
        .then((snapshots) {
      setState(() {
    ...
    await orderServices
        .getOrderByUserID(widget.userID, status6)
        .then((snapshots) {
      setState(() {
    ...
    print(status7);
    await orderServices
        .getOrderByUserID(widget.userID, status7)
        .then((snapshots) {
      setState(() {
        ...
        appBar: AppBar(
          bottom: TabBar(
            ...
            unselectedLabelStyle:
                const TextStyle(fontSize: 14, fontFamily: 'Helvatica'),
            overlayColor:
