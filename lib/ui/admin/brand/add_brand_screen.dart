            ...
            child: SingleChildScrollView(
                ...
                child: Padding(
                  ...
                  child: Column(children: [
                    ...
                    StickyLabel(
                        text: 'Image', textStyle: TextStyle(fontSize: 14)),
                    imageFile == null
                        ? Container(
                        ...
                        if (formKey.currentState!.validate()) {
                          if (imageFile == null) {
                            ...
                            Fluttertoast.showToast(
                                msg:
                                    'Please add image before adding a new brand.',
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.BOTTOM);
                          } else {
                            String imageUrl = await imageServices
                                .addImageAndReturnString(imageFile);
                            int newBrandID = brandServices
                                .getNewBrandID(brandProvider.brands);
                            MBrand new_brand = new MBrand(
                                id: newBrandID,
                                name: nameBrand,
                                imageUri: imageUrl,
                                productQuantity: 0,
                                totalSoldOut: 0);
                            bool result =
                                await brandServices.addBrand(new_brand);
                            if (result == false) {
                              addButtonController.stop();
                              Fluttertoast.showToast(
                                  msg:
                                      'Some errors happened when adding a new brand.',
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.BOTTOM);
                            } else {
                              ...
                              Future.delayed(const Duration(milliseconds: 1500),
                                ...
                                addButtonController.stop();
                                Fluttertoast.showToast(
                                    msg: 'Add new brand successfully.',
                                    toastLength: Toast.LENGTH_SHORT,
                                    gravity: ToastGravity.BOTTOM);
                              });
                            }
