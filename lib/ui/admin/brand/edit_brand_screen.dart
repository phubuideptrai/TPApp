                    ...
                    CustomRoundedLoadingButton(
                      ...
                      onPress: () async {
                        ...
                        if (formKey.currentState!.validate()) {
                          ...
                          bool result1 =
                              await brandServices.updateBrandName(widget.brand);
                          bool result2 = true;
                          if (imageFile != null) {
                            String imageUrl = await imageServices
                                .addImageAndReturnString(imageFile);
                            widget.brand.setImage(imageUrl);
                            result2 = await brandServices
                                .updateBrandImage(widget.brand);
                          }
                          ...
                          if (result1 == true && result2 == true) {
                            ...
                            Future.delayed(const Duration(milliseconds: 1500),
                              ...
                              Fluttertoast.showToast(
                                  msg: 'Update selected brand successfully.',
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.BOTTOM);
                            });
                          } else {
                            Fluttertoast.showToast(
                                msg: 'Some errors happened when updating.',
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.BOTTOM);
                          }
                        } else
